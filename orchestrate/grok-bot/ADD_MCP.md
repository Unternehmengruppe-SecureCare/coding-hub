...
GitHub-Org-Webhook (nach Deploy): `https://pathology-playlist-bookstore-php.trycloudflare.com/api/github/webhook`, Events `issues` und `pull_request`. Label `cursor` oder `agent` ingestiert den inneren Loop.
