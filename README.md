...
4. CLI MCP: `grok mcp add --transport http coding-hub https://administrators-revised-finance-interracial.trycloudflare.com/mcp`
5. Im Bot chatten:
...
6. Optional: [grok.com/connectors](https://grok.com/connectors) → Custom → `https://administrators-revised-finance-interracial.trycloudflare.com/mcp`
7. Dieses Repo in Grok öffnen — Skill `cursor-dispatch`, Agent, `.mcp.json`
